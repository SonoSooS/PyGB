...
OP_JR_cc = (JR_cc, JR, generic_fetch)
...
OP_LD_r8_n8 = (generic_fetch_op1, LD_r8_n8)
...
OP_LD_r8_uHL = (generic_fetch_uHL, LDR_r8_DV)
...
OP_RET = (RET_M0, RET_M1, RET_M2, generic_fetch)
OP_RET_cc = (RET_cc, RET_M0, RET_M1, RET_M2, generic_fetch)
OP_RETI = (RET_M0, RET_M1, RETI_M2, generic_fetch)
OP_JP = (generic_fetch_op1, generic_fetch_op2, JP_ok, generic_fetch)
OP_JP_cc = (generic_fetch_op1, JP_cc, JP_ok, generic_fetch)
OP_JP_HL = (JP_HL,)
OP_CALL = (generic_fetch_op1, generic_fetch_op2, generic_push_PC_M0, generic_push_PC_M1, generic_push_PC_M2, CALL)
OP_CALL_cc = (generic_fetch_op1, CALL_cc, generic_push_PC_M0, generic_push_PC_M1, generic_push_PC_M2, CALL)
OP_RST = (generic_push_PC_M0, generic_push_PC_M1, generic_push_PC_M2, RST_M3)
OP_DI = (DI,)
OP_EI = (EI,)
OP_CB = (CB_mode,)
OP_PUSH = (PUSH_M0, PUSH_M1, PUSH_M2, generic_fetch)
OP_POP = (POP_M0, POP_M1, POP_M2)
...
ISR = (ISR_decrement_PC, generic_push_PC_M0, generic_push_PC_M1, ISR_push_PC_M2, generic_fetch)
